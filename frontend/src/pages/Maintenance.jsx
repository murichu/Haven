...
const Maintenance = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center animate-in fade-in duration-500">
            ...
            <h1 className="text-4xl font-black text-gray-900 tracking-tight mb-4">Maintenance Requests</h1>
            <p className="text-gray-500 max-w-md mx-auto font-medium leading-relaxed">
                Track unit repairs, scheduled inspections, and vendor assignments in real-time.
            </p>
